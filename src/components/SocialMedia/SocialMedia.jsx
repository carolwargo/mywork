...
<div className="col-sm-12 col-md-3 col-lg-3 p-2 d-flex flex-column justify-content-center">
   <div className="data-body p-3 ">
               <div className="data-title">
                 ...
                 <ul style={{fontSize:'12px'}}>
                 <li>Algorithim Changes</li>
                    <li>Saturation of competition</li>
...
<div className="col-sm-12 col-md-3 col-lg-3 p-2 d-flex flex-column justify-content-center">
  <div className="data-body p-2 ">
              ...
              <ol className="mb-2" style={{ fontSize: "12px" }}>
               <li>Use snippets to entice & drive Users to a controlled platform.</li>
               <li>Create meaningful content; Quality {">"} Quantity.</li>
               <li>Use share buttons.</li>
               <li>Host a contest or giveway</li>
               <li>Give reminders</li>
                <li>Provide real-time updates</li>
               <li>BE PATIENT AND STUDY THE DATA.</li>
              </ol>
            </div>
          </div>
